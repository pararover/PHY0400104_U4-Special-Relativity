\section{Effects of relativity}
	...
	\subsection{Length contraction}
		...
		Then the rod would be at rest with respect to the moving frame $S'$. If $x_1'$ and $x_2'$ are the coordinates of either ends of the rod in the frame $S'$, then the natural length of the rod is
		\begin{align}
